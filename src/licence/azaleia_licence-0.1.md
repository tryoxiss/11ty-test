...
<blockquote class="callout callout--warning">
    ...
    <p>All content put under the Azaleia Licence is technechally all rights reserved. I am not a lawyer, I wrote this, this has not been audited by a lawyer. Please do not mistake this for a legal document. </p>
...
13. **Azaleia Licence** refers to this document. **This Licence** has a corresponding meaning.
...
1. **Source Avalible**: If the work also exists in, or results from, any sort of source files which are not provided (for example, source code), must: 
    ...
    2. If any changes were made, you must also distribute those changes in source form, and they must also be under this licence. 
